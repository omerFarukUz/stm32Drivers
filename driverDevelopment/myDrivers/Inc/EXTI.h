...
#define EXTI_TRIGGER_All			(0x10U)


typedef struct
{
	uint8_t EXTI_LineNumber;					/*!< EXTI Line number for valid GPIO pin @def_group EXTI_Line_Values >*/
	uint8_t TriggerSelection;					/*!< EXTI Trigger selection Values @def_group EXTI_Trigger									 >*/
	uint8_t EXTI_Mode;							/*!< EXTI Mode value @def_group EXTI_Modes 							 >*/
